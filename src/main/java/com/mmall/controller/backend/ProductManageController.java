...
public class ProductManageController {
    ...
    public ServerResponse productSave(HttpSession session, Product product) {
        ...
        if (iUserService.checkAdminRole(user).isSuccess()) {
            // 增加增加产品业务逻辑
            return iProductService.savrOrUpdateProduct(product);
        } else {
    ...
    @ResponseBody
    public ServerResponse getList(HttpSession session, @RequestParam(value = "pageNum", defaultValue = "1") int pageNumber,
